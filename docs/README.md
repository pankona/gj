...
どの部分をアニメーションさせたいか？を検討する。全部実装するわけではないがとりあえずダンプしておく。
- 赤虫/青虫が建物を攻撃する
  - とりあえず建物に向かって体当たりをしているような動きでもよさそう
  - がぶがぶ噛みついたりする絵も出せれば出したいがちょっと時間的にきついか
- 虫が移動する
  - 本当は手足をかさかさ動かしたい
  - そんな素材はないので実現性は低い
- 虫が倒される
  - 潰れたとか弾けたとか、そういう絵を表示したい
  - ぬるぬる動かしたいけどいったん一枚の絵で表現でもいいか
- 建物を建てる
  - 足元に煙が出るみたいなエフェクトがほしい
- 建物が壊れる
  - 爆発するアニメーションにしたいが
  - 簡易的に済ますならば ebitengine の機能でぺちゃんこになるように変形してもいいかもしれない
- 家が壊れる
  - 爆発させたい
  - これもいったんぺちゃんこでいいか
- 建物が壊れそう
  - 煙が出たりボヤになったりしている絵がほしい
  - 止め絵を重ねて表示するだけでもいいかも 
...
- 虫が建物を攻撃するときの音
  - 近接攻撃は ゲシゲシ みたいな音
  - 遠距離攻撃は何かを飛ばす音 シュッシュッ みたいな
- 手で攻撃する音
  - ベシッ みたいな
- 建物が攻撃する音
  - ビーム撃つときは ぴっぴっ みたいな
  - 範囲攻撃のほうは爆発音でもいいかもしれない ボンボン のような
- 建物が壊れるときの音
  - 積み木が崩れるときの ガラガラ みたいな音がいいかもしれない
  - 爆発音でもいいが、攻撃と音がかぶらないほうがよさそう
- ショップで何かを選んだときの音
  - ぴっぴっ みたいなやつかな
- 建物を置いたときの音
  - どん みたいな音
- Ready 押したときの音
  - ウェーブ開始を告げる音なので、勢いのある音がよいかも
  - バキューン みたいなやつ
- ゲーム終了時の音
  - クリアしたらなんかめでたい感じの音を鳴らしたい
  - ゲームオーバーだったら残念でした的な音を鳴らしたい
- BGM
  - (Option) ウェーブ中途建築中で分けてもいいかも
  - 少なくとも一曲はずっと鳴らしとこうかな
